...
class ControllerPaymentIntellectmoney extends Controller
{
	...
	protected function index()
	{
		...
		$this->data['recipientAmount'] = $this->currency->format($order_info['total'], isset($order_info['currency']) ? $order_info['currency'] : $order_info['currency_code'], isset($order_info['value']) ? $order_info['value'] : $order_info['currency_value'], FALSE);
